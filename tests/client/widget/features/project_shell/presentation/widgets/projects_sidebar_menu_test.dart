...
void main() {
  group('ProjectsSidebar File Menu Tests', () {
    testWidgets('should display menu button with correct icon', (
      WidgetTester tester,
    ) async {
      // Arrange & Act
    ...
    testWidgets('should display all menu options when menu is opened', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(
    ...
    testWidgets('should display correct icons for each menu option', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(
    ...
    testWidgets('should show exit confirmation dialog when Salir is tapped', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(
    ...
    testWidgets('should dismiss exit dialog when Cancelar is tapped', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(
    ...
    testWidgets('should show close project confirmation dialog', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(
    ...
    testWidgets('should dismiss close project dialog when cancelled', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(
    ...
    testWidgets('should have menu dividers between sections', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(
    ...
    testWidgets('should have Abrir Proyecto option in menu', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('menu button should have proper styling', (
      WidgetTester tester,
    ) async {
      // Arrange & Act
      await tester.pumpWidget(
  ...
  group('ProjectsSidebar Menu Integration Tests', () {
    testWidgets('should maintain state after opening and closing menu', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(
    ...
    testWidgets('should update icon count with new exit menu option', (
      WidgetTester tester,
    ) async {
