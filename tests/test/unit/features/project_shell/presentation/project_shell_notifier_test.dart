...
void main() {
  group('ProjectShellNotifier', () {
    ...
    group('selectProject', () {
      test('should update selected project', () async {
        ...
        expect(notifier.state.selectedProject, equals(testProject));
        // Note: updateLastOpened should not be called when just selecting a project
        // verifyNever is not strictly necessary as the state check above confirms this
      });
    });
