...
- [DOCKER_COMPOSE_GUIDE.md](02-DOCKER/DOCKER_COMPOSE_GUIDE.md) - Guía completa de Docker Compose
- [DOCKER_COMPOSE_AUDIT.md](02-DOCKER/DOCKER_COMPOSE_AUDIT.md) - Auditoría de seguridad
- [DOCKER_COMPOSE_UPDATE_SUMMARY.md](02-DOCKER/DOCKER_COMPOSE_UPDATE_SUMMARY.md) - Changelog de actualizaciones
- [DOCKER_SETUP_LOG.md](02-DOCKER/DOCKER_SETUP_LOG.md) - Troubleshooting de Docker
...
- *(Próximamente: GitHub Actions, pre-commit hooks, pipelines de deployment)*
