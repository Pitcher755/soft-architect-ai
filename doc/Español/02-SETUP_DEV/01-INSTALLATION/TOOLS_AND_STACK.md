...
This documento collects the complete inventory of tools used both for proyecto management and conception (Meta-Tools) and for its technical implementación (Tech Stack).
...
| :--- | :--- | :--- |
| **Google Gemini** | **Thought Partner & Planner** | Landing ideas, task planning, infrastructure configuracións, technical research and error correction. |
...
| **Notion** | **Proyecto Management** | Task tracking, milestone checklist and repository of quick notes. |
| **n8n** | **Automation Orchestrator** | Low-Code engine in HomeLab. Synchronizes documentoation and manages Webhooks. |
| **Notion API** | **Knowledge CMS** | Final destination of living documentoation. Integrated via n8n. |

## 2. Development Environment (Dev Environment)
Physical and logical infrastructure where the code is cooked.

| Tool | Use | Configuración |
| :--- | :--- | :--- |
| **HomeLab (CasaOS)** | **Main Server** | Visual OS over Ubuntu. Manages Docker, Volumes and Networks graphically. |
| **Laptop (Linux/Ryzen)** | **Thin Client** | User interface and pruebaing environment for powerful Local AI. |
...
---
## 4. Stack Update (Local Implementación Fase)
