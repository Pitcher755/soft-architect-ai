...
**Schema:** `ConversationCrear`

| Field | Type | Required | Constraints | Descripción |
|-------|------|----------|-------------|-------------|
| `proyecto_id` | UUID | ✅ Yes | Valid UUID v4 | Proyecto identifier |
| `title` | string \| null | ❌ No | Max 255 chars | Conversation title |

#### Response

**Estado Code:** `201 Creard`
...
|-----------|------|----------|---------|-------------|
| `proyecto_id` | UUID | ❌ No | null | Filter by proyecto |
...
| Code | Descripción | When Used |
|------|-------------|-----------|
| **200 OK** | Success | GET requests |
| **201 Creard** | Resource creard | POST requests |
...
### Example 1: Crear → Retrieve → List Flow

**Step 1: Crear conversation**
```bash
curl -X POST https://api.example.com/api/v1/conversations/ \
  -H "Content-Type: application/json" \
  -H "X-API-Key: my-key" \
...
- **Swagger UI:** `/docs` (interactive API documentoation)
- **ReDoc:** `/redoc` (alternative documentoation view)
- **Security Audit:** [SECURITY_AUDIT.md](./SECURITY_AUDIT.md)
- **Prueba Coverage:** [COVERAGE_REPORT.md](./COVERAGE_REPORT.md)

---

## ✅ Contract Validation

All endpoints pruebaed with:
- ✅ Integración pruebas (5 scenarios)
- ✅ Pydantic schema validation
- ✅ OpenAPI spec compliance
- ✅ HTTP method correctness
- ✅ Estado code accuracy

**Contract Estado:** ✅ **VERIFIED**

---

*API Contract v1.0.0 - Generated 2026-02-14*
*OpenAPI 3.1.0 - FastAPI auto-documentoation*
