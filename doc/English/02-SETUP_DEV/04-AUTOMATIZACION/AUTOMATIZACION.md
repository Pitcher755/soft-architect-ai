...
Este document describe los pipelines de automatización que mantienen sincronizada la documentación y el código of the project.
...
* **Orqustatusr:** n8n (Self-hosted en HomeLab vía CasaOS).
...
1.  **Trigger:** `GitHub Webhook` detecta un `push` que modifica files Markdown (`.md`).
2.  **Extracción:** Se descarga el contenido "raw" del file modificado.
