...
Este document recoge el inventario completo de herramientas utilizadas tanto para la gestión y concepción of the project (Meta-Herramientas) como para su implementation técnica (Tech Stack).
...
| **Notion** | **Gestión de Project** | Seguimiento de tareas, checklist de hitos y repositorio de notas rápidas. |
| **n8n** | **Orqustatusr de Automatización** | Motor Low-Code en HomeLab. Sincroniza la documentación y gestiona Webhooks. |
...
| Herramienta | Uso | Configuration |
| :--- | :--- | :--- |
| **HomeLab (CasaOS)** | **Servidor Principal** | SO visual sobre Ubuntu. Gestiona Docker, Volúmenes y Redes de forma gráfica. |
| **Portátil (Linux/Ryzen)** | **Cliente Fino** | Interfaz de usuario y entorno de tests para IA Local potente. |
...
### Backend & IA
* **Python 3.11 + FastAPI:** API Server y orqustatusr de lógica.
...
* **Riverpod:** Gestión de status reactiva.

### Infraestructura
* **Docker Compose:** Orquestación de servicios (BD, API, IA).

---
## 4. Actualización de Stack (Phase de Implementation Local)
